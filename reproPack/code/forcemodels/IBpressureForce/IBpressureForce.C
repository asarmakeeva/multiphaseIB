...
defineTypeNameAndDebug(IBpressureForce, 0);
...
IBpressureForce::IBpressureForce(
    ...
    : forceModel(dict, sm),
      ...
      HFieldName_(propsDict_.lookupOrDefault<word>("HFieldName", "H")),
      H_(sm.mesh().lookupObject<volVectorField>(HFieldName_))
{
...
void IBpressureForce::setForce() const
{
    vector force;
